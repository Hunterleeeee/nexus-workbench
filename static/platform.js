...
function setupThemeToggle() {
  if (!document.querySelector("link[data-workbench-theme]")) { const link = document.createElement("link"); link.rel = "stylesheet"; link.href = "/static/theme.css?v=0.3.213"; link.dataset.workbenchTheme = "true"; document.head.append(link); }
...
function renderIntegrationFields(item = {}) {
  ...
  const help = qs("#integration-panel-help"); if (help) help.textContent = `${item.description || ""} 密钥只保存于 NEXUS 服务端，不会回显到页面。`;
