...
function setupThemeToggle() {
  if (!document.querySelector("link[data-workbench-theme]")) { const link = document.createElement("link"); link.rel = "stylesheet"; link.href = "/static/theme.css?v=0.3.208"; link.dataset.workbenchTheme = "true"; document.head.append(link); }
...
if ("serviceWorker" in navigator) {
  navigator.serviceWorker.getRegistrations()
    ...
    .then(() => navigator.serviceWorker.register("/static/sw.js?v=0.3.208", { scope: "/" }))
    .catch(() => {});
}
const icons = {
